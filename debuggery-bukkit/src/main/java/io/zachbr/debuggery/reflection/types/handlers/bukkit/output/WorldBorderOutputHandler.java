...
public class WorldBorderOutputHandler implements OutputHandler<WorldBorder> {

    @Override
    public @Nullable String getFormattedOutput(WorldBorder border) {
    ...
    @Override
    public @NotNull Class<WorldBorder> getRelevantClass() {
